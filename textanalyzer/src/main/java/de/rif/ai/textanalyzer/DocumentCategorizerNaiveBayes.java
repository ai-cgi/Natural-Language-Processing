...
public class DocumentCategorizerNaiveBayes {
	...
	public static void main(String[] args) {
		...
		try {
			...
			InputStreamFactory dataIn = new MarkableFileInputStreamFactory(
					new File("./src/main/resources/data/en-movie-category.train"));
			...
			BufferedOutputStream modelOut = new BufferedOutputStream(
					new FileOutputStream("./src/main/resources/data/en-movie-classifier-naive-bayes.bin"));
